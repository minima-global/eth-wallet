...
const TokenList = () => {
  const { _currentNavigation, promptTokenDetails, setTriggerBalanceUpdate, _triggerBalanceUpdate } = useContext(appContext);
  ...
  return (
    <div className="mx-4 md:mx-0">
      ...
      {_triggerBalanceUpdate && <p className="text-center text-xs font-bold opacity-50 animate-pulse">Fetching balance...</p>}
            ...
            <div className="flex justify-between ml-2">
              <div>
                ...
                <p className="font-mono text-sm">
                  {token.balance &&
                    formatUnits(token.balance, token.name === 'Tether' && _network === 'sepolia' ? 18 : 6).toString()}
                </p>
              </div>
            </div>
          </li>
