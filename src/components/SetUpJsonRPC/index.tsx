...
const SetUpJsonRPC = () => {
  ...
  return (
    <AnimatedDialog up={3000} dismiss={() => null} display={_promptJsonRpcSetup}>
      <div className="overflow-y-auto max-h-full h-[calc(100%_-_86px)]">
        ...
        {step === SETUPSTATE["FORM"] && (
          <div className={`px-4 grid h-full md:h-max grid-rows-[1fr_86px]`}>
            <main className="grid grid-cols-[1fr_minmax(0,_560px)_1fr]">
              <div />
              <section className="text-left">
                <h1 className="text-2xl font-bold dark:text-orange-300">
                ...
                <input
                  ...
                  className="w-full p-2 rounded-lg text-2xl truncate bg-gray-100 dark:bg-gray-800 font-mono focus:border-none focus:outline-none dark:placeholder:text-teal-300 font-bold"
                />
                <p className="mt-2 text-[13px] font-bold dark:text-neutral-500">
                  You can find this in your API Settings where you can click to
                  reveal your secret.
                </p>
                <ul className="list-none p-0 m-0 space-y-2 my-4 mt-4">
                  <li>
                  ...
                  <li className="flex items-center space-x-2">
                    <input
                      ...
                      className="form-checkbox h-5 w-5 accent-teal-300 min-w-[24px]"
                    />
                    <label htmlFor="ethereumCheckbox" className="text-sm sm:text-base">
                  ...
                  <li className="flex items-center space-x-2">
                    <input
                      ...
                      className="form-checkbox h-5 w-5 accent-teal-300 min-w-[24px]"
                    />
                    <label htmlFor="expansionCheckbox" className="text-sm sm:text-base">
                  ...
                  <li className="flex items-center space-x-2">
                    <input
                      ...
                      className="form-checkbox h-5 w-5 accent-teal-300 min-w-[24px]"
                    />
                    <label htmlFor="saveCheckbox" className="text-sm sm:text-base">
        ...
        {step === SETUPSTATE["CHECK"] && (
          <div className={`px-4 grid grid-rows-[1fr_86px] h-full md:h-max`}>
            <main className="grid grid-cols-[1fr_minmax(0,_560px)_1fr]">
              <div />
              <section className="text-left">
                {!error && loading && (
