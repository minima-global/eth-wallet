  ...
  return (
    ...
    tokenB) ? (
      <Formik
          ...
          inputAmount: yup
            ...
            .test("check for insufficient funds", async function (val) {
              ...
              try {
                ...
                if (
                  new Decimal(val).decimalPlaces() >
                  parent.tokenA.token.decimals
                ) {
        ...
        onSubmit={async ({ tx }, { setFieldValue }) => {
          if (!tx) return;
      ...
      <p className="text-center text-xs pt-1 dark:text-neutral-400">Refreshing your experience...</p>
    </div>
  );
};
