...
function GasEstimation() {
  ...
  return (
    <div>
      <AnimatedDialog up={2000} display={showGasCards} dismiss={() => null}>
        <div className=" bg-white shadow-lg shadow-slate-300 dark:shadow-sm dark:bg-[#1B1B1B] w-[calc(100%_-_16px)] md:w-full p-4 pb-2 px-0 rounded mx-auto">
          <div className="flex justify-between pr-4">
            <h3 className="mx-4 pb-4 font-bold">Gas Station</h3>
            <svg
          ...
          {!loading && (
            <div className="text-center">
              <div className="grid grid-cols-3 mx-4 text-sm">
                <h3 className="font-bold text-neutral-900 dark:text-neutral-500">Gas option</h3>
                <h3 className="font-bold text-neutral-900 dark:text-neutral-500">Time</h3>
                <h3 className="font-bold text-neutral-900 dark:text-neutral-500">Max fee (ETH)</h3>
              </div>
              {gas && gas.gasUnits && (
          ...
          <div className="px-4">
            ...
            <div className="grid grid-cols-2 divide-x">
              <div className="text-center py-1">
                <p>
                  {utils.createDecimal(gasCardData!.estimatedBaseFee) !==
                    null &&
              ...
              <div className="text-center py-1">
                <p>
                  {utils.createDecimal(
                    gasCardData!.latestPriorityFeeRange[0]
                  ) !== null &&
                  ...
                  -{" "}
                  {utils.createDecimal(
                    gasCardData!.latestPriorityFeeRange[1]
                  ) !== null &&
      ...
      {!gasInfo && !loading && (
        <p className="text-xs text-center">Awaiting Gas Information...</p>
      )}
        ...
        <>
          ...
          >
            <h3 className="font-bold">
              Gas Fee{" "}
              <span
                className={`${level === "high" && "text-violet-500"} ${
                  level === "low" && "text-sky-500"
                } ${
                  level === "medium" && "text-neutral-700 dark:text-neutral-500"
                } text-xs`}
              >
                ({level})
              </span>
            ...
            {!gas && loading ? (
              ...
              <div className="text-right">
                <p className="text-xs sm:text-base">{gas.finalGasFee}</p>
                {/* <ConversionRateUSD
              ...
              {gas && !loading && (
                <div className="text-right font-mono">
                  {formik.values.asset.type === "ether" && (
                    <div className="flex">
                      <h3 className="text-sm font-bold">
                        {utils.createDecimal(formik.values.amount) !== null &&
                  ...
                  {formik.values.asset.type === "erc20" && (
                    <div>
                      <h3 className="font-mono font-bold text-xs sm:text-base">
